...
def g_unet(nf, a_ch=1, b_ch=1, out_ch=1, alpha=0.2,
    ...
    conv8 = Conv2D(nf*8, (3, 3), padding='valid', strides=(1, 1))(x)
    conv8 = BatchNormalization(axis=3)(conv8)
    x = LeakyReLU(alpha)(conv8)
    # (1, 1, nf*8)

    dconv1 = Conv2DTranspose(nf*8, (3, 3), strides=(1, 1))(x)
    ...
    dconv2 = Conv2DTranspose(nf*8, (3, 3), strides=(2, 2))(x)
    ...
    dconv3 = Conv2DTranspose(nf*8, (3, 3), strides=(2, 2))(x)
    ...
    dconv4 = Conv2DTranspose(nf*8, (3, 3), strides=(2, 2))(x)
    ...
    dconv5 = Conv2DTranspose(nf*4, (3, 3), strides=(2, 2))(x)
    ...
    dconv6 = Conv2DTranspose(nf*2, (3, 3), strides=(2, 2))(x)
    ...
    dconv7 = Conv2DTranspose(nf, (3, 3), strides=(2, 2))(x)
    ...
    dconv8 = Conv2DTranspose(out_ch, (3, 3), strides=(2, 2))(x)
    # (256, 256, out_ch)
