...
\begin{frame}\frametitle{Введение}
	...
	\begin{figure}
		\centering{\includegraphics[width=0.3\linewidth]{trend-sample}}
...
\begin{frame}\frametitle{Обучение GAN}
	...
	\begin{columns}
		...
		\column{0.5\linewidth}
			\begin{figure}
				\centering{\includegraphics[width=0.65\linewidth]{gan-training}}
...
\begin{frame}\frametitle{pix2pix GAN}
	...
	\begin{columns}
		\column{0.5\linewidth}
			\begin{figure}
				\centering{\includegraphics[width=0.85\linewidth]{p2p}}
...
\begin{frame}\frametitle{Критерий качества}
	...
	\begin{columns}
		...
		\column{0.4\linewidth}
			\begin{figure}
				\centering{\includegraphics[width=0.7\linewidth]{metrics}}
		...
		\begin{columns}
			\column{0.33\linewidth}
				\begin{minipage}{1\linewidth}
					\centering{\includegraphics[width=0.5\linewidth]{nf8} \\ nf8}
				\end{minipage}
				\vfill
				\begin{minipage}{1\linewidth}
					\centering{\includegraphics[width=0.5\linewidth]{nf16} \\ nf16}
				\end{minipage}
			\column{0.33\linewidth}
				\begin{minipage}{1\linewidth}
					\centering{\includegraphics[width=0.5\linewidth]{nf16_woUnet} \\ nf16-woUnet}
				\end{minipage}
				\vfill
				\begin{minipage}{1\linewidth}
					\centering{\includegraphics[width=0.5\linewidth]{nf16_3x3_woUnet} \\ nf16-3x3-woUnet}
				\end{minipage}
			\column{0.33\linewidth}
				\begin{minipage}{1\linewidth}
					\centering{\includegraphics[width=0.5\linewidth]{nf32} \\ nf32}
				\end{minipage}
				\vfill
				\begin{minipage}{1\linewidth}
					\centering{\includegraphics[width=0.5\linewidth]{nf32_woUnet} \\ nf32-woUnet}
				\end{minipage}
		\end{columns}
